...
(function () {
  var questions = [
    {
      //Soal 1
      question: "I ... here before.", //Penulisan soal
      choices: ["am", "is", "were", "was", "will"], //Array pilihan jawaban
      correctAnswer: 3, //Pilihan array jawaban yang benar
    },
    {
      //Soal 2
      question: "The pigeon fly ... the house.", ///Penulisan soal
      choices: ["below", "on", "over", "inside", "under"], //Array pilihan jawaban
      correctAnswer: 2, //Pilihan array jawaban yang benar
    },
    {
      //Soal 3
      question: "The last time I met her, she ..... for a new job in Jakarta the following day", //Penulisan soal
      choices: ["is leaving", "is left", "was leaving", "was left", "All correct"], //Array pilihan jawaban
      correctAnswer: 2, //Pilihan array jawaban yang benar
    },
    {
      //Soal 4
      question: "I .... waiting an hour for the job interview", //Penulisan soal
      choices: ["have", "had", "have been", "had been", "was"], //Array pilihan jawaban
      correctAnswer: 3, //Pilihan array jawaban yang benar
    },
    {
      //Soal 5
      question: "Next week they will .... to Jakarta from Pangkal Pinang", //Penulisan soal
      choices: ["be flying", "flying", "fly", "can fly", "can flying"], //Array pilihan jawaban
